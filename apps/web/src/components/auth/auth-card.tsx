  ...
  return (
    <div className="readji-surface w-full max-w-[600px] rounded-[2rem] p-8 shadow-[0_30px_80px_-42px_rgb(45_29_32_/_0.62)] sm:p-10">
      <Link href="/" className="flex items-center justify-center">
        {/* โลโก้เต็ม (ไอคอนแมว + ตัวอักษร) ที่ user วาดมา (public/readji-logo-full.png — trim ขอบ
            โปร่งใสออกแล้วจากต้นฉบับ "Readji 2 Logo with text.png") ใส่ gradient แบบเดียวกับ
            navbar (components/navbar/index.tsx) — CSS mask เอารูปมาเป็นแม่พิมพ์ วาด gradient สี
            เดียวกัน (--primary น้ำตาลเข้ม → --ring ชมพูฝุ่น) ไว้ข้างใต้ */}
        <span
          role="img"
          aria-label="Readji"
