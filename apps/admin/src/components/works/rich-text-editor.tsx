...
// พอร์ตมาจาก apps/web/src/components/writer/rich-text-editor.tsx ตรงๆ (2026-08-04) — ใช้แก้ทั้ง
// "เรื่องย่อ" (synopsis) และ "เนื้อหาตอน" (ep_content ผ่าน tiptapToNovelBlocks) เหมือนฝั่ง writer เป๊ะ
