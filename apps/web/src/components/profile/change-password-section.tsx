...
import type { ChangePasswordInput } from '@/interface/account-security.interface'
  ...
  return (
    <section aria-labelledby="change-password-heading" className="rounded-2xl border border-border/70 bg-card p-5 shadow-sm sm:p-6">
      ...
      {hasPassword ? (
        ...
        <p className="mt-3 text-sm leading-6 text-muted-foreground">บัญชีนี้ยังไม่มีรหัสผ่านสำหรับเข้าสู่ระบบ คุณสามารถเข้าสู่ระบบด้วย Google ได้</p>
      )}
    </section>
  )
}
